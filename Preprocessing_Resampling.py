...
def extractFeature(wav_file,target_sr):
...
def extractFeatureMemory(y, sr, target_sr):
  # y, sr = librosa.load(wav_file, sr=44100)
...
def main():
  ...
  extractFeature('./data/fart_clean1_mono.wav',50)
  extractFeature('./data/negative_sample_party_mono.wav',50)
  extractFeature('./data/negative_sample_voice_mono.wav',50)
